...
#include <cstdint>
	...
	#define MXC_INFO(message, ...) ::mxc::logOutput(::mxc::LogLevel::debug, __FILE__, __LINE__, message, ##__VA_ARGS__)
#else
	#define MXC_INFO(...)
#endif
	...
	#define MXC_WARN(message, ...) ::mxc::logOutput(::mxc::LogLevel::debug, __FILE__, __LINE__, message, ##__VA_ARGS__)
#else
	#define MXC_WARN(...)
#endif

#ifdef MXC_LOGLEVEL_ERROR
	#define MXC_ERROR(message, ...) ::mxc::logOutput(::mxc::LogLevel::debug, __FILE__, __LINE__, message, ##__VA_ARGS__)
#else
	#define MXC_ERROR(...)
#endif

#ifdef MXC_LOGLEVEL_TRACE
	#define MXC_TRACE(message, ...) ::mxc::logOutput(::mxc::LogLevel::debug, __FILE__, __LINE__, message, ##__VA_ARGS__)
#else
	#define MXC_TRACE(...)
#endif
