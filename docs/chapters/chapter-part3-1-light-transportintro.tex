...
\begin{table}[tb]
	\begin{tabularx}{\linewidth}{Yc}
		...
		\midrule
		\multicolumn{2}{>{\hsize=\dimexpr2\hsize- + 2\tabcolsep\relax}X}{8 campioni per strata}\\
		...
		\midrule
		\multicolumn{2}{>{\hsize=\dimexpr2\hsize- + 2\tabcolsep\relax}X}{40 campioni per strata}\\
		...
		\midrule
		\multicolumn{2}{>{\hsize=\dimexpr2\hsize- + 2\tabcolsep\relax}X}{200 campioni per strata}\\
		...
		\midrule
		\multicolumn{2}{>{\hsize=\dimexpr2\hsize- + 2\tabcolsep\relax}X}{1000 campioni per strata}\\
		...
		\midrule
		\multicolumn{2}{>{\hsize=\dimexpr2\hsize- + 2\tabcolsep\relax}X}{5000 campioni per strata}\\
...
\end{table}
\footnotetext{Ciascuna componente RGB \`e assunta normalizzata}
