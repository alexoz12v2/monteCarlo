...
\ref{chapter6:MCExample:1Dfunction}\subref{chapter6:MCExample:1Dfunction:error}
...
Come esempio di applicazione, si consideri il campionamento con distribuzione uniforme di dominio pari ad un quarto di disco unitario, 
...
quale vale la detailed balance property
\begin{align}
...
\end{equation}
cioe' il cammino casuale non dipende dalla direzione ma solo dalla distanza.\par
